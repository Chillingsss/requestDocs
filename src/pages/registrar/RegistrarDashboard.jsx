																	...
																	{req.hasAdditionalRequirements > 0 && (
																		<div className="flex gap-1 items-center mt-1">
																			<div className="relative">
																				<span className="inline-flex gap-1 items-center px-2 py-1 text-xs font-medium text-orange-800 bg-orange-100 rounded-full dark:text-orange-400 dark:bg-orange-900/20">
