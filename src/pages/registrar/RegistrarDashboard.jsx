...
export default function RegistrarDashboard() {
	...
	return (
		<div className="flex overflow-hidden h-screen bg-slate-50">
			...
			{/* Sidebar - Fixed positioning for proper scrolling */}
			<aside
				className={`fixed top-0 left-0 z-30 flex flex-col bg-slate-900 text-white transition-all duration-300 h-screen ${
					sidebarOpen
						? "w-64 translate-x-0"
					...
					<nav className="flex flex-col gap-2">
						{navItems.map((item, idx) => (
							<button
								...
								className={`flex gap-3 items-center px-3 py-2 text-white rounded transition-colors bg-slate-800 hover:bg-slate-700 ${
			...
			{/* Main Content - Properly positioned with margin for sidebar */}
			<main
			...
			>
				...
				{/* Desktop Header */}
				<header className="hidden justify-between items-center p-4 bg-white border-b lg:p-8 lg:flex">
